...
public class FileDialog extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(name.alr.android_shopper.R.layout.file_dialog_main);
		myPath = (TextView) findViewById(name.alr.android_shopper.R.id.path);
		mFileName = (EditText) findViewById(name.alr.android_shopper.R.id.fdEditTextFile);
		...
		selectButton = (Button) findViewById(name.alr.android_shopper.R.id.fdButtonSelect);
		...
		final Button newButton = (Button) findViewById(name.alr.android_shopper.R.id.fdButtonNew);
		...
		layoutSelect = (LinearLayout) findViewById(name.alr.android_shopper.R.id.fdLinearLayoutSelect);
		layoutCreate = (LinearLayout) findViewById(name.alr.android_shopper.R.id.fdLinearLayoutCreate);
		...
		final Button cancelButton = (Button) findViewById(name.alr.android_shopper.R.id.fdButtonCancel);
		...
		final Button createButton = (Button) findViewById(name.alr.android_shopper.R.id.fdButtonCreate);
	...
	private void getDirImpl(final String dirPath) {
		...
		myPath.setText(getText(name.alr.android_shopper.R.string.location) + ": " + currentPath);

		if (!currentPath.equals(ROOT)) {

			item.add(ROOT);
			addItem(ROOT, name.alr.android_shopper.R.drawable.folder);
			path.add(ROOT);

			item.add("../");
			addItem("../", name.alr.android_shopper.R.drawable.folder);
		...
		SimpleAdapter fileList = new SimpleAdapter(this, mList, name.alr.android_shopper.R.layout.file_dialog_row, new String[] {
				ITEM_KEY, ITEM_IMAGE }, new int[] { name.alr.android_shopper.R.id.fdrowtext, name.alr.android_shopper.R.id.fdrowimage });

		for (String dir : dirsMap.tailMap("").values()) {
			addItem(dir, name.alr.android_shopper.R.drawable.folder);
		}

		for (String file : filesMap.tailMap("").values()) {
			addItem(file, name.alr.android_shopper.R.drawable.file);
		}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (file.isDirectory()) {
			...
			if (file.canRead()) {
				...
				new AlertDialog.Builder(this).setIcon(name.alr.android_shopper.R.drawable.android_icon)
						.setTitle("[" + file.getName() + "] " + getText(name.alr.android_shopper.R.string.cant_read_folder))
